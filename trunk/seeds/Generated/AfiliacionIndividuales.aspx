    ...
    <TABLE>
        ...
        <tr>
            <td>
                ...
                ErrorMessage="Requerido" Display="Dynamic" ControlToValidate="Dummy12" ValidationGroup="grpValidation2"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <!--AAAAMMDD-->
        <tr>
    ...
    <TABLE>
        ...
        <tr>
            <td>
                ...
                ErrorMessage="Requerido" Display="Dynamic" ControlToValidate="Dummy44" ValidationGroup="grpValidation3"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <!--obligatorio si Ocupación Actual = 2 -->
        <tr>
