...
<%@ Page Language="C#" Inherits="CAFAM.WebPortal.Forms.AfiliacionEmpresas" Title="Formulario" MasterPageFile="~masterurl/default.master" EnableSessionState="True" %>
...
<link rel="Stylesheet" href="~/_layouts/StyleSheet.css" type="text/css" />
    ...
    <table class="ms-formbody" style="width:700px" id="Table1" runat="server">
        <tr>
            <td>
                <asp:Wizard runat="server" ID="wzDatosDelTrabajador" Font-Names="verdana" CssClass="ms-formbody"
