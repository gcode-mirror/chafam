...
<%@ Page Language="C#" CodeBehind="rptAfiliacionIndividuales.aspx.cs" Inherits="CAFAM.WebPortal.Forms.rptAfiliacionIndividuales" Title="Formulario" MasterPageFile="~masterurl/default.master" EnableSessionState="True" %>
...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server" ID="MainContent">
    <rsweb:ReportViewer ID="rptVisualizadorReport" runat="server" Font-Names="Verdana" 
        ...
        <LocalReport ReportPath="../CAFAM.WebPortal.Forms/Reports/rptAfiliacionIndividuales.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>    
</asp:Content>