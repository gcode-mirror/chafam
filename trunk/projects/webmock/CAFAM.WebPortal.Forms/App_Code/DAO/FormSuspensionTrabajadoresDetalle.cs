...
namespace DAO {
	public sealed class FormSuspensionTrabajadoresDetalle {
		#region Fields
		private int iD;
		private int iDSusp;
		...
		/// </summary>
		public FormSuspensionTrabajadoresDetalle() {
		}
		
		/// <summary>
		/// Initializes a new instance of the TblFormSuspensionTrabajadoresDetalle class.
		/// </summary>
		public FormSuspensionTrabajadoresDetalle(int iDSusp, string idType, string idNumber, string firstName, string secondName, string firstSurname, string secondSurname, string suspentionStart, string suspentionStop) {
			this.iDSusp = iDSusp;
			this.idType = idType;
		...
		/// Initializes a new instance of the TblFormSuspensionTrabajadoresDetalle class.
		/// </summary>
		public FormSuspensionTrabajadoresDetalle(int iD, int iDSusp, string idType, string idNumber, string firstName, string secondName, string firstSurname, string secondSurname, string suspentionStart, string suspentionStop) {
			this.iD = iD;
			this.iDSusp = iDSusp;
			this.idType = idType;
			this.idNumber = idNumber;
