...
<%@ Page Language="C#" Inherits="CAFAM.WebPortal.Forms.Novedades" Title="Formulario" MasterPageFile="~masterurl/default.master"%>
...
<asp:WizardStep ID="wzPersonasACargoStep" runat="server" StepType="auto" Title="">
    <TABLE>
       ...
       <tr>
        ...
        <!--es un check, hijo, hijastro, adoptivo, hermano, padre-->
        <tr>
            <td>
