...
namespace CAFAM.WebPortal.Forms
{
    ...
    {
        private FormAfiliacionEmpresa AfiliacionEmpresa;
       ...
       protected void OnFinish(object sender, WizardNavigationEventArgs e)
       {
           ...
           AfiliacionEmpresa= new FormAfiliacionEmpresa(txtNit.Text,txtNombreORazonSocial.Text,txtCiudad.Text, 
           ...
           wzDatosDelTrabajador.FinishDestinationPageUrl = "rptAfiliacionEmpresa.aspx";
       }
