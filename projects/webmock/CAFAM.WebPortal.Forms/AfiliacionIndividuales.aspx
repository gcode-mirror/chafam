<%@ Page Language="C#" Inherits="CAFAM.WebPortal.Forms.AfiliacionIndividuales" Title="Formulario" MasterPageFile="MasterPage.master"%>
...
<asp:Wizard runat="server" ID="wzDatosDelTrabajador" Font-Names="verdana" CssClass="content-more"
   ...
   OnActiveStepChanged="OnActiveStepChanged" OnFinishButtonClick="OnFinish" ActiveStepIndex="1"
