...
<script type='text/javascript'>
    ...
    <table class="ms-formbody" style="width:700px" id="tblMain" runat="server">
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtSubNit" Width="50px" CssClass="form_text" MaxLength="2"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <tr>
            <td>
                <asp:TextBox runat="server" ID="txtNombreORazonSocial" Width="400px" CssClass="form_text" MaxLength="34"/>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="updentidades" runat="server">
                    <ContentTemplate>
                        <asp:GridView AllowPaging="true" PageSize="5" ID="gvTrabajadores" runat="server"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="bntGuardarEImprimir" CssClass="form_button_submit" runat="server" Text="Guardar e Imprimir"
                                OnClick="bntGuardarEImprimir_Click" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
